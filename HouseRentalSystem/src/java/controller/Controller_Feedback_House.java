 ...
 * @author win
 */
public class Controller_Feedback_House extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            dAOHouse.insertFeedBack(h,acc.getId(),content);
            List<Feedback> list = dAOHouse.getFeedbackByHouseId(houseID);
            Gson gson = new Gson();
